...
def composite(dval1, dval2):
    mountimg = Image.open('d:/Screenshots/Emily/sameD pairs/Mountains/s' + str(mtnSeedNum) + '_d' + dval1 + '.png').convert("RGBA")  # Mountain Image
    cloudimg = Image.open('d:/Screenshots/Emily/sameD pairs/Coastlines/s' + str(cloudSeedNum) + '_d' + dval2 + '.png').convert("RGBA")  # Cloud Image
    ...
    comp.save(r'd:\screenshots\_Fractal Soup\3_sameD_combos\seed' + str(mtnSeedNum) + '_' + str(cloudSeedNum) + '_D' + str(x) + '_' + str(y) + '.png', 'PNG')


# Combos are stored in two lists:
list1 = [1.1, 1.3, 1.5, 1.7, 1.9,
         1.1, 1.3, 1.5, 1.7, 1.9,
         1.1, 1.3, 1.5, 1.7, 1.9,
         1.1, 1.3, 1.5, 1.7, 1.9,
         1.1, 1.3, 1.5, 1.7, 1.9,
